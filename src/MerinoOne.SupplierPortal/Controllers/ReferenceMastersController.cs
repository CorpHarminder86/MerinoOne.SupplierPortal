...
{
    // ---------------- Currency ----------------
    [HttpGet("currencies"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("currencies/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("currencies"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("currencies/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("currencies/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- Country ----------------
    [HttpGet("countries"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("countries/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("countries"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("countries/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("countries/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- State ----------------
    [HttpGet("states"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("states/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("states"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("states/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("states/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- City ----------------
    [HttpGet("cities"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("cities/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("cities"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("cities/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("cities/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- PostalCode ----------------
    [HttpGet("postal-codes"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("postal-codes/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("postal-codes"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("postal-codes/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("postal-codes/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- Unit ----------------
    [HttpGet("units"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("units/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("units"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("units/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("units/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    // ---------------- ItemGroup ----------------
    [HttpGet("item-groups"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("item-groups/{id:guid}"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpPost("item-groups"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPut("item-groups/{id:guid}"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpPost("item-groups/{id:guid}/deactivate"), Authorize(Policy = "Settings.Write")]
    ...
    [HttpGet("geo/countries"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("geo/states"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("geo/cities"), Authorize(Policy = "Settings.Read")]
    ...
    [HttpGet("geo/postal-codes"), Authorize(Policy = "Settings.Read")]
