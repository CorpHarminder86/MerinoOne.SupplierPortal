...
Field caps (400 on violation): erpStatus <=50, poOrigin <=50, paymentTermCode/deliveryTermCode <=20; per line itemCode REQUIRED <=50, orderUnit <=20, taxCode <=20.
