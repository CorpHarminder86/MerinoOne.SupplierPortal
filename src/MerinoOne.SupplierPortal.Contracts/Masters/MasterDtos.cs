...
public record CreateItemRequest(string Code, string Description, string Uom, string? HsnCode, bool IsActive = true);
...
public record UpdateItemRequest(string Description, string Uom, string? HsnCode, bool IsActive);
...
/// </summary>
public record UpsertItemRequest(string Code, string Description, string Uom, string? HsnCode, bool IsActive = true);
